...
- [x] 1.3 Set up Prisma with PostgreSQL database
...
- [x] 1.4 Configure NextAuth.js v5 for authentication
...
- [x] 1.5 Set up project folder structure
...
- [x] 2.1 Create Zod validation schemas for authentication
...
- [x] 2.2 Implement user registration API endpoint
...
- [x] 2.3 Implement password reset API endpoints
...
- [x] 2.4 Create authentication UI pages
...
- [x] 2.5 Write unit tests for authentication validation schemas
...
- [x] 3. Image upload functionality
- [x] 3.1 Set up Vercel Blob storage integration
...
- [x] 3.3 Build reusable ImageUpload component
...
- [x] 4. Plant management features
- [x] 4.1 Create Zod validation schemas for plants
...
- [x] 4.2 Implement Plant CRUD API endpoints
...
- [x] 4.3 Create React Query hooks for plant data fetching
...
- [x] 4.4 Build Zustand store for plant filters
...
- [x] 4.5 Create plant UI components
...
- [x] 4.6 Build plant management pages
...
- [x] 5. Care schedule management
- [x] 5.1 Create Zod validation schemas for schedules
...
- [x] 5.2 Create date utility functions for schedule calculations
...
- [x] 5.3 Implement Care Schedule CRUD API endpoints
...
- [x] 5.4 Create React Query hooks for schedule data
...
- [x] 5.5 Build schedule UI components
...
- [x] 5.6 Build schedule management pages
...
- [x] 5.7 Write unit tests for date utility functions
  - Test calculateNextDueDate with various inputs
  - Test edge cases (leap years, month boundaries)
  - Test timezone handling
  - _Requirements: 4.2, 4.5_

- [x] 6. Task completion and care history
- [x] 6.1 Create Zod validation schemas for tasks
...
- [x] 6.2 Implement Care Task API endpoints
...
- [x] 6.3 Create React Query hooks for task data
...
- [x] 6.4 Build task UI components
...
- [x] 6.5 Build task and history pages
...
- [x] 7. Dashboard and navigation
- [x] 7.1 Create dashboard layout components
...
- [x] 7.2 Build dashboard home page
...
- [x] 7.4 Implement global state and providers
...
- [x] 7.5 Create landing page for unauthenticated users
...
- [x] 8. Notification preferences and setup
- [x] 8.1 Create notification preferences API endpoints
...
- [x] 8.2 Build notification preferences UI
...
- [x] 9. Email notification system
- [x] 9.1 Set up Resend email service integration
...
- [x] 9.2 Implement email notification logic in cron job
...
- [x] 10.1 Set up Firebase Cloud Messaging
...
- [x] 10.2 Implement service worker for push notifications
...
- [x] 10.3 Build push notification permission flow
...
- [x] 10.4 Implement push notification logic in cron job
...
- [x] 10.5 Implement notification click handling
...
- [x] 11. Automated task checking with Vercel Cron
- [x] 11.1 Create cron job API endpoint
...
- [x] 12. Security hardening and error handling
...
- [x] 12.4 Add authorization checks to all protected routes
...
- [x] 13. Performance optimization (partial)
- [x] 13.1 Optimize database queries
...
- [x] 13.2 Implement image optimization
...
- [x] 15.1 Set up testing infrastructure
